...
class _RelationshipHubPage extends StatefulWidget {
  const _RelationshipHubPage();

  @override
  State<_RelationshipHubPage> createState() => _RelationshipHubPageState();
}

class _RelationshipHubPageState extends State<_RelationshipHubPage> {
          ...
          slivers: [
             ...
             SliverPadding(
               ...
               sliver: SliverGrid.count(
                 ...
                 crossAxisSpacing: 12,
                 children: const [
                   _InteractiveMetricTile(title: 'Communication', score: '94%', reason: 'Mercury aligns well today. Words flow easily.', icon: Icons.chat_bubble_outline_rounded, color: Color(0xFF8784B4)),
                   _InteractiveMetricTile(title: 'Intimacy', score: '82%', reason: 'Venus provides a warm, protective emotional shell.', icon: Icons.favorite_border_rounded, color: Color(0xFFDEA080)),
                   _InteractiveMetricTile(title: 'Trust', score: '90%', reason: 'Saturn anchors your shared foundations securely.', icon: Icons.shield_outlined, color: Color(0xFF788B7A)),
                   _InteractiveMetricTile(title: 'Growth', score: '75%', reason: 'Jupiter is retrograde; focus on internal lessons.', icon: Icons.park_outlined, color: Color(0xFFE7AD5D)),
                 ]
               )
             ),
...
class _InteractiveMetricTile extends StatefulWidget {
  final String title;
  final String score;
  final String reason;
  final IconData icon;
  ...
  @override
  State<_InteractiveMetricTile> createState() => _InteractiveMetricTileState();
}

class _InteractiveMetricTileState extends State<_InteractiveMetricTile> {
